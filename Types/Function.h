...
namespace ts{
    namespace objects{
        ...
        public:
            ...
            inline const std::vector<TSDATA>& captures() const{return _captures;}
            inline size_t_Array* getLocRefTable() const{return _proc.getRefMap();}
            inline const Procedure& getProc() const{return _proc;}
            inline const Procedure* getProcPtr() const{return &_proc;}
            
            inline const NativeFunction* getNative() const{return _native;}
            ...
            virtual const size_t size(){return sizeof(Function);}
