...
namespace ts {
    ...
    namespace type{
        ...
        public:
            ...
            virtual TYPE type(){return TYPE::TBASIC;}
        ...
        public:
            ...
            inline const std::vector<Type*>& argsTypes(){return _argsTypes;}
            inline Type* returnType(){return _returnType;}
            
            inline void setReturnType(Type* t){_returnType=t;}
            
            inline void setNative(bool r){_isNative=r;}
            inline bool isNative(){return _isNative;}
            inline void setAbstract(bool a){_isAbstract=a;}
            inline bool isAbstract(){return _isAbstract;}
            ...
            virtual TYPE type(){return TYPE::TFUNCTION;}
        ...
        public:
            ...
            inline Type* elementsType(){return _elementsType;}
            inline TSINT nbElements(){return _nbElems;}
            
            virtual bool equals(Type* other);
            virtual TYPE type(){return TYPE::TARRAY;}
            virtual std::string toString();
        ...
        public:
            ...
            inline nodes::ClassNode* getClass(){return _class;}
            inline void setClassDefIndex(size_t index){_classDefIndex=index;}
            inline size_t getClassDefIndex(){return _classDefIndex;}
            
            virtual TYPE type(){return TYPE::TCLASS;}
        ...
        public:
            ...
            inline nodes::InterfaceNode* getInterface(){return _interface;}
            ...
            virtual TYPE type(){return TYPE::TINTERFACE;}
        ...
        public:
            ...
            inline void setClass(ClassType* c){_class=c;}
            inline ClassType* getClass(){return _class;}
            inline const std::vector<InterfaceType*>& getInterfaces(){return _interfaces;}

            virtual bool equals(Type* other);
            virtual TYPE type(){return TCOMPOSED;}
            virtual std::string toString();
        ...
        public:
            ...
            inline const std::vector<Type*>& types(){return _types;}
            inline const size_t refMapIndex(){return _refMapIndex;}
            
            virtual bool equals(Type* other);
            virtual TYPE type(){return TYPE::TTUPLE;}
            virtual std::string toString();
        ...
        public:
            ...
            virtual TYPE type(){return TYPE::TSTRUCT;}

            inline const std::string& name(){return _name;}
            inline const std::vector<nodes::Argument*>& fields(){return _fields;}
