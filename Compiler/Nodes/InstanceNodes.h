...
namespace ts{
    ...
    namespace nodes{
        ...
        public:
            ...
            inline ClassNode* getClass(){return _class;}
            inline bool scoped(){return _scoped;}
            ...
            virtual NODE_TYPE getNodeType(){return N_NEW_INSTANCE;}
        ...
        public:
            ...
            virtual NODE_TYPE getNodeType(){return N_ATTRIBUTE_ACCESS;}
        ...
        public:
            ...
            inline size_t definitionIndex(){return _defIndex;}
            void setDefinitionIndex(size_t defIndex);

            inline void setIsForFunctionCall(bool v){_forFunctionCall=v;}
            
            virtual void semanticTraverse();
            virtual void pushBytecode(std::vector<TSINSTR>& program);
            virtual std::string toString();
            
            virtual NODE_TYPE getNodeType(){return N_VIRTUAL_ACCESS;}
        ...
        public:
            ...
            virtual NODE_TYPE getNodeType(){return N_IMPLEMENTATION_ACCESS;}
