...
namespace ts {
    ...
    namespace nodes{
        ...
        public:
            ...
            inline type::ClassType* typeClass(){return _classType;}
            
            const std::vector<DefinitionReferenceNode*>& defs(){return _defs;}
            ...
            inline const std::vector<Argument*>& getAttributes(){return _attrs;}
            ...
            virtual NODE_TYPE getNodeType(){return N_CLASS;}
