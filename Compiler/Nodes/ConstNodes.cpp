...
namespace ts {
    namespace nodes{
        ...
        std::string BooleanNode::toString(){return T_toString(_value);}
        ...
        std::string IntegerNode::toString(){return T_toString(_value);}
        ...
        std::string RealNode::toString(){return T_toString(_value);}
