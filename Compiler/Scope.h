...
namespace ts {
    ...
    namespace cmplr{
        ...
        public:
            ...
            inline type::Type* type() const{return _ref ? _ref->type() : _type;}
            inline void setType(type::Type* t){_type=t;}
        ...
        public:
            ...
            inline size_t index() const{return _index;}
            inline nodes::AbstractNode* value() const{return _value;}
            inline type::Type* type() const{return _type;}

            inline void setIndex(size_t i){_index=i;}
            inline void setValue(nodes::AbstractNode* val){_value=val;}
            inline void setType(type::Type* t){_type=t;}
            ...
            inline Definition* getNextOverloadedDefinition() const{return _nextOverloadedDef;}
        ...
        public:
            ...
            inline Scope* parent() const{return _parent;}
            inline void setIndependant(){_offset=0; _independant=true;}
            ...
            inline const std::map<std::string, Variable*>& getLocals(){return _locals;}
            inline const std::map<std::string, Definition*>& getDefs(){return _defs;}
