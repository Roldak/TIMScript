...
namespace ts{
    ...
    public:
        ...
        inline const std::vector<Procedure*>& constantPool(){return _constantPool;}
        inline const TSDATA* nativesPool(){return _nativesPool;}
        inline const size_t mainRefMapIndex(){return _main_refmap_index;}
        inline const size_t mainExTableIndex(){return _main_extable_index;}
        inline Procedure* main(){return _main_proc;}
